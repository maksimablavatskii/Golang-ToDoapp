...
const docTemplate = `{
        ...
        "/statistics": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Фильтрация статистики по ID пользователя",
                        "name": "user_id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Начало рассмотрети статистики (Включительно), формат: YYYY-MM-DD",
                        "name": "from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Конец рассмотрения промежутка статистики(не включительно), формат: YYYY-MM-DD",
                        "name": "to",
                        "in": "query"
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_maksimablavatskii_Golang-ToDoap_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
    ...
    "definitions": {
        "github_com_maksimablavatskii_Golang-ToDoap_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
